...
export const Route = createFileRoute("/clients/$studentId")({
  ...
  loader: async ({ params }) => {
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_145_6_145_45_11`,"Error fetching:", error));
      throw error;
    }
  },
...
function ClientRoutinesPage() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_279_6_279_57_11`,"Error al eliminar la rutina", error));
  ...
  const handleExercises = async (muscleGroupId: number, isNew: boolean = false) => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_314_6_314_61_11`,"Error al obtener los ejercicios", error));
  ...
  const handleSearchDatePickerDate = async (date: Date | undefined) => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_332_6_332_45_11`,"Error fetching:", error));
  ...
  const handleSaveNewExercise = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_378_6_378_57_11`,"Error al crear el ejercicio", error));
  ...
  const handleRefreshExercises = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_394_6_394_48_11`,"Error al refrescar", error));
  ...
  const handleUpdateRoutine = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_473_6_473_59_11`,"Error al actualizar la rutina", error));
      notify.error(
        "Error al actualizar",
  ...
  const handleSaveRoutine = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`61444073_567_6_567_56_11`,"Error al guardar la rutina", error));
