...
export const Route = createFileRoute("/clients/$studentId_/edit")({
  ...
  loader: async ({ params: { studentId } }) => {
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`2199996567_53_6_53_68_11`,"Error en loader de edición de cliente:", error));
      return {
        studentId,
        studentData: null,
...
function ClientEditPanelPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`2199996567_131_6_131_63_11`,"Error al guardar ajuste de racha:", error));
      notify.error(
        "Error al guardar",
