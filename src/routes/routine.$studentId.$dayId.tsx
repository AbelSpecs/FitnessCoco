...
export const Route = createFileRoute("/routine/$studentId/$dayId")({
  ...
  loader: async ({ params }) => {
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`565769500_93_6_93_26_11`,error));
...
function DayDetail() {
  ...
  const handleExerciseComplete = async (ex: Exercise, studentNotes?: string) => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`565769500_197_6_197_26_11`,error));
      throw error;
    }
  };
...
function ExerciseRow({
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`565769500_273_6_273_26_11`,error));
    } finally {
      setLoading(false);
    }
  };
...
function DetailsSetsRow({
  ...
  const handleSetsUpdate = async (set: DailyExerciseSets, exId: number) => {
    ...
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`565769500_376_6_376_26_11`,error));
      return;
    } finally {
      setReps("");
      setWeight("");
